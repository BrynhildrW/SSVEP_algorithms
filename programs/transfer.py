...
def tlcca_als_optimize(
    ...
    r_init = np.tile(
        A=utils.sin_wave(freq=freq, n_points=n_points, phase=0, srate=srate),
    ...
    wX, rH = w_new @ X_mean, r_new @ H
    return {'w': w_new, 'r': r_new, 'wX': wX, 'rH': rH, 'n_iter': n_iter}
